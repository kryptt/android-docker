...
glusterfs-host-tree/    GlusterFS install extracted from the hr-fleet container
                        image; deploy-device.sh pushes this to /data/glusterfs/
                        on the device (gitignored; generated by
                        scripts/extract-glusterfs-host-tree.sh)
